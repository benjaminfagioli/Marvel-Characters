...
const ErrorDialog = () => {
  return (
    <div id='errorDialog' className='d-flex justify-content-center h-50 position-relative d-none d-lg-flex'>
      <img className='img-fluid opacity-50 object-fit-contain' src={errorImage} alt="Iron-Man destroyed" />
